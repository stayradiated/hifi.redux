...
export const FILTER_LIBRARY_ALBUMS = 'FILTER_LIBRARY_ALBUMS'
...
export const FILTER_LIBRARY_ARTISTS = 'FILTER_LIBRARY_ARTISTS'
...
export const SET_PLAYLIST_TITLE = c('SET_PLAYLIST_TITLE')
export const MOVE_PLAYLIST_ITEM = c('MOVE_PLAYLIST_ITEM')
export const RESET_LIBRARY_PLAYLISTS = 'RESET_LIBRARY_PLAYLISTS'
export const RESET_PLAYLIST_ITEMS = 'RESET_PLAYLIST_ITEMS'

export const FETCH_LIBRARY_PLAYLISTS_REGULAR = c(
...
export const FILTER_LIBRARY_TRACKS = 'FILTER_LIBRARY_TRACKS'
...
export const UI_SET_LIBRARY_SECTION_ID = 'UI_SET_LIBRARY_SECTION_ID'

// genres
export const FETCH_LIBRARY_GENRES = c('FETCH_LIBRARY_GENRES')

// countries
export const FETCH_LIBRARY_COUNTRIES = c('FETCH_LIBRARY_COUNTRIES')
